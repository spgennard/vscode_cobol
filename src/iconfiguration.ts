...
export interface ICOBOLSettings {
    ...
    linter_ignore_malformed_using: boolean;
    ...
    margin_identification_area: boolean;
    ...
    codelens_copybook_refresh: boolean;
}
...
export class COBOLSettings implements ICOBOLSettings {
    ...
    constructor() {
        ...
        this.linter_ignore_malformed_using = true;
        ...
        this.margin = true;
        this.margin_identification_area = true;
        ...
        this.codelens_copybook_refresh = true;
    }
