...
* [732922ba1102578](https://github.com/spgennard/vscode_cobol/commit/732922ba1102578) *2021-09-16 21:11:43*

## 7.9.15
 
**update changelog**

* [e9db7917adbe292](https://github.com/spgennard/vscode_cobol/commit/e9db7917adbe292) *2021-09-16 21:11:20*

**Update CHANGELOG.md**

* [d0fc0d3a85be8de](https://github.com/spgennard/vscode_cobol/commit/d0fc0d3a85be8de) *2021-09-10 20:11:08*

## 7.9.9
 
**remove use of prefer_gnucobol_syntax**

* [b65a551744c8cca](https://github.com/spgennard/vscode_cobol/commit/b65a551744c8cca) *2021-09-10 20:10:20*

**update to next vscode engine**

* [656379e173a4fd5](https://github.com/spgennard/vscode_cobol/commit/656379e173a4fd5) *2021-09-09 20:59:37*

**Update CHANGELOG.md**

* [9d21ae5ea6b5e40](https://github.com/spgennard/vscode_cobol/commit/9d21ae5ea6b5e40) *2021-09-09 20:56:59*

## 7.9.8
 
### GitHub [#297](https://github.com/spgennard/vscode_cobol/issues/297) Go to definition 
 
**handle single line '/' - Fix #297**

* [eaa8529d70aa1b0](https://github.com/spgennard/vscode_cobol/commit/eaa8529d70aa1b0) *2021-09-09 20:56:01*

**prep**

* [20ea0882372ffc0](https://github.com/spgennard/vscode_cobol/commit/20ea0882372ffc0) *2021-09-09 20:56:37*

**Update CHANGELOG.md**

* [bc7d465dfe25aaf](https://github.com/spgennard/vscode_cobol/commit/bc7d465dfe25aaf) *2021-09-05 23:02:11*
...
**Ensure '/' is treated as comment during file processing**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md Fix #297
...
**add config to package.json and add reinit() and ensure init() is used**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md when needed
...
**move list of id's into config (wip)**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md ensure first paragraph is picked up when we have a &quot;fake&quot; pd
...
**remove features that extended the 'Micro Focus COBOL Extension'**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md to be compliant with its license.
...
**ensure metadata is not used when extending the mf extension**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - leave in memory cache in place
...
**add support for picking up source format from the mf settings**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - this enables the commenter to be in-sync
...
**fix compilation bug introduced by previous refactoring**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md add support for using the &#x27;real&#x27; Micro Focus extension
...
**refactor debugger check and allow people using gnucobol language to**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md bypass the check
...
**Update README.md**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - make labels easier to read
...
**update README**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md remove unused property
...
**move getSourceFormat into a seperate file and add langid to doc, so it**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md can be used with out of process scanner
...
**Margin setting not respected Fix #285**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - blank lines caused fixed file format detection to break

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - lines &gt; 80 should case fixed file format detection to be considerred

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - allow coboleditor.margin to overide file format
...
**add more abbr to snippets**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md add more information to the extension checks
...
**continue refactoring cobscanner/vscobscanner**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - move file scanner to own mechanism

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - use workspace findFile approach for scanner

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - drop unused list of directories
...
**start to move vscobscanner code to seperate class, so the non-dep can be**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md moved forward without the restrictions imposed by the old dep&#x27;ed code
...
**continue work on cobscanner**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - fix bug with not updating a timestamp
...
**continue to work on scanner**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - useenv mode setup
...
**fix a 'replace' problem**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md start to refactor cobscanner
...
**reduce the amount of items cached to the workspace at the expense of**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md resolving them via the workspace
...
**avoid bad entry in cache**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md empty cache if depreciated setting is used
...
**use a inactivity based timer rather than a length of time timer**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - inactivity is a lack of any message from the scanner
...
**VSCode become unresponsible after run processAllFilesInWorkspace command in a huge worskspace Fix #282**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - Wire up cache_metadata_time_limit, so processAllFilesInWorkspace can

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md be cancelled early

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - Change the process indicator to be finer
...
**start to wire in existing token'ed copy statement**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - fix start to be before &#x27;copy&#x27; verb
...
**continue work on references**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md change $end-region to match $region
...
**prepare for delivery**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - only say the pp failed when it has fatally failed &amp; log it
...
**re-enable "decl" section processing (hopefull does not break anything)**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md tweak setting of fixed format
...
**make the determination of fixed file format better**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md don&#x27;t register interest in tokens that are literals

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md (long standing silent bug)
...
**use of support.variable.cobol, was too gready, it colourised too much**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md remove margin statusbar as it is pointless
...
**avoid using meta.symbol.cobol, as it is not friendly to some themes**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md add config for alias, simplify lang use
...
**add lowercase cobol, so "alias" is configure the same way as the**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md uppercase one
...
**(from experimental feature)**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - drop syntax task, as it does not work as good as I hoped it would
...
**continue background work on workspace caching**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - make workspace entries portable
...
**move to using one obj that will eventually contain portable/non-portable**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md filename information
...
**start the process of re-introducing the workspace external process cache**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - does not work at the moment :-(
...
**start to rework the pp to be enabled by a list of extensions,**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md hopefully allow them to be full active at the same time as this ext.
...
**continue work on pp**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - alter start to include packageJson of package registering

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md so more detailed error handling/information can be generated

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md later

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - add callback interface for extra info used while pp&#x27;ing
...
**add support for handling a external file system for gotodef (alias of**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md prg-id)
...
**add clear internal memory cache cmd**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md continue work on pp
...
**add more pp support**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md add cross process support for ep/prg&#x27;s to scanner
...
**add onEnterRules for call/evaluate**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md remove experimental example from readme, as it is not present
...
**paragraphs missing in outline Fix #266**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - parsing of comment lines via the scanner internals was changing

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md the behavour on multi-line scanning
...
**update packages, remove html parser as it is not used (was for the**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md failed coboldoc support)
...
**Move away from using uuid, as it seems to cause a clash on Windows,**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md other platforms are okay.
...
**Metadata parsing misses some sections #255**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - tweak symbol catcher and event generator
...
**current tags and releases missing Fix #258**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - include changelog generation
...
**changes to better handle implicit program-ids**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md fix problem with untrimmed token that do not end with a full stop
...
**add depreciated tags to the settings that are scheduled for**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md replacement or removal
...
**turn off git/release as it will now only be used for private non-public**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md builds
...
**add simple formatter for camelcase/uppercase on return-code**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - under experimential flag
...
**tidy up use of COBOLUtils, move to statics, as no instance data is**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md required
...
**remove "Open COBOL" reference**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md add note, about contributions &amp; gnucobol extension
...
**Update stale.yml**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md tweak
...
**add more keywords from the iso2002 spec and add a config to ignore the**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md first section if an entyr-point is next, its crudge needs more

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md improvement
...
**remove the last the non-module gnucobol bits, the extension is now split**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md into two.
...
**continue the removal of anything GnuCOBOL related, so it can be**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md pushed into its own extension.

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md plus tidy up in utils
...
**continue minor tweaks to task provider.. more work to do here...**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md comment out subjective code in keyword provider, as I have send times it

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md causes more harm than good (aka it prevents keywords from being

 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md returned)
...
**tweak the brackets support to handle if/end-if and a few more**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md (more may come, I just want to see who this pans out)
...
**add schema, as the original one has gone.. so include so I can reference**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md it
...
**add some cbltypes as support.function**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md add 78 specific colouriser
...
**tweaks for more field types for bms**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - fix unrequired , in package.json
...
**start to think about web use of the extension**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md - can&#x27;t do too much until I get codespace access
...
**add support for "exec java" used in some java based COBOL dialects**
 ...
 acucobol.configuration.json bld_cobscanner_and_sdk.sh CHANGELOG_7.9.md CHANGELOG.md cobol.configuration.json cobolit.configuration.json cobscanner CODE_OF_CONDUCT.md dir.configuration.json dist docs gen_changelog.sh gen_third_party.sh hlasm.configuration.json images jcl.configuration.json justpublish.sh LICENSE node_modules out package.json package-lock.json pli.configuration.json publishit2gitonly.sh publishit.sh README.md rm_git_release.sh schemas sdk.zip snippets spg src syntaxes theme THIRD-PARTY-NOTICES.txt tsconfig.json webpack.config.js workspace.code-workspace x x.md fix &quot;-&quot; in first column that affected some comment lines
